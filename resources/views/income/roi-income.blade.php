...
<div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow" style="padding-top: 10px;margin-top: 10px;">
    <h2 class="text-2xl font-semibold mb-4 " style="margin-left: 10px;margin-top: 10px">ROI Income List</h2>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="border px-4 py-2">
                            @if($income->credit_type == 0)
                                <span class="bg-blue-500 text-white px-2 py-1 rounded">Credited</span>
                            @else
